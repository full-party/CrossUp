 ...
 * Generated for Laravel 5.4.19 on 2017-06-18.
 *
...
namespace App\Facades {
    ...
    class UserService {
         ...
         * @static 
         */
        public static function store($parameter)
        {
            return \App\Service\UserService::store($parameter);
        }
    ...
    class GameService {
        ...
        {
            return \App\Service\GameService::list();
        }
        ...
        {
            return \App\Service\GameService::find($gameId);
        }
    ...
    class ComboService {
        ...
        {
            return \App\Service\ComboService::find($id);
        }
        ...
        {
            return \App\Service\ComboService::list($params);
        }
    ...
    class CharacterService {
         ...
         * @static 
         */
        public static function list($gameId)
        {
            return \App\Service\CharacterService::list($gameId);
        }
...
namespace {
    ...
    class GameService extends \App\Facades\GameService {}
    
    class ComboService extends \App\Facades\ComboService {}
    
    class CharacterService extends \App\Facades\CharacterService {}
